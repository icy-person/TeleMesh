...
export default function App(){
 ...
 const [historyMore,setHistoryMore]=useState(false),[loadingMore,setLoadingMore]=useState(false),[reply,setReply]=useState<Message|null>(null),[editing,setEditing]=useState<Message|null>(null),[search,setSearch]=useState(""),[searchResults,setSearchResults]=useState<Message[]>([]);
